...
export default {
    ...
    data() {
        return {
            bgiamge: '/static/bg-2.png',
            adimages: ['/static/ad-5.png'],
            bottom: [
                {title: '我的收益', callback: () => {
                    wx.navigateTo({
    ...
    onShareAppMessage() {
        // console.log(stores.state.buyerId)
        return {
            title: '推荐有奖',
...
.ad-image .ad-button button {
    background-color: #2c6aea;
    border-radius: .8rem;
    height: .8rem;
    line-height: .8rem;
    color: #fff;
...
.bottomBtn li:first-child {
    text-align: right;
    border-right: 1px solid #2a70d4;
}
</style>
