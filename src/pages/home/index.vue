...
export default {
    data() {
        return {
            ...
            iconData: [
                {title: '推荐有奖', icon: '/static/icon-1.png', class: "orange", callback(){
                    wx.navigateTo({
                        url: '/pages/recommend/main'
                    })
                }},
                {title: '优秀供应商', icon: '/static/icon-2.png', class: 'yellow', callback(){
                    wx.navigateTo({
                        url: '/pages/excellentSupplier/main'
                    })
                }},
                {title: '我的收益', icon: '/static/icon-3.png', class: 'green', callback(){
                    wx.navigateTo({
                        url: '/pages/income/main'
                    })
                }},
                {title: '个人中心', icon: '/static/icon-4.png', class: 'blue', callback(){
                    wx.navigateTo({
            ...
            share: [
                {title: '邀请报价', icon: '/static/icon-7.png', callback(){
                    wx.navigateTo({
                        url: '/pages/purchaseOrderDefault/main'
                    })
                }},
                {title: '分享到朋友圈', icon: '/static/icon-5.png', callback: () => {
                ...
                {title: '查看供应商', icon: '/static/icon-6.png', callback(){
                    wx.navigateTo({
                        url: '/pages/excellentSupplier/main'
                    })
                }},
...
.tab .tab-toggle > li.active span {
    border-bottom: .06rem solid #4f95f7;
    color: #4f95f7;
}
